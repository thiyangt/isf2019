...
\begin{exampleblock}{Peeking inside FFORMS!!!}
  \begin{itemize}
    ...
    \item \textcolor{red}{When} and \textcolor{red}{how} strongly each feature interacts with
other features?
  \end{itemize}
\end{exampleblock}
\end{textblock*}
...
\end{itemize}
\item causality: change in the value of Y for an increase or decrease in the value of x
\begin{itemize}
...
## Feature importance plot for hourly data

```{r vihourly, fig.pos="h", out.width="98%", out.height="98%", dev="png"}

```

## Partial dependency plots for hourly data: Seasonality

```{r seasonalityhourly,out.width="105%", fig.pos="h"}
